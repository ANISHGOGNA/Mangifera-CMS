<?php
  ...
  $query=mysqli_query($bd, "update users set fullName='$fname',contactNo='$contactno',address='$address',State='$state',country='$country',pincode='$pincode', userImage='$userImage' where userEmail='".$_SESSION['login']."'");
  if($query)
  {
  ...
  if(isset($_FILES['profile_photo']) && $_FILES['profile_photo']['error'] === UPLOAD_ERR_OK) {
    ...
    if (move_uploaded_file($_FILES["profile_photo"]["tmp_name"], $target_file)) {
        ...
        // Now you can update the 'userImage' column in the database
        // with the path stored in $photo_path
        // Example SQL update query:
        // UPDATE users SET userImage='$photo_path' WHERE id='$user_id';
    } else {
